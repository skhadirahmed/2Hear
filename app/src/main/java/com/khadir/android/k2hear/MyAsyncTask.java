...
public class MyAsyncTask extends AsyncTask<ArrayList<MusicDetails>, Void, ArrayList<MusicDetails>> {
    ...
    public MyAsyncTask(MusicMainActivity musicMainActivity, ArrayList<MusicDetails> musicDetails) {
        mContext = musicMainActivity;
...
//        MusicMainActivity.musicDetails = musicDetails;
    }
